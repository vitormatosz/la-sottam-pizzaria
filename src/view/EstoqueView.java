...
public class EstoqueView extends JPanel {
    ...
    private RoundedTextField unidadeField;
    ...
    private JPanel buildTablePanel() {
        ...
        for (int i = 0;
                i < tabelaEstoque.getColumnCount();
                i++) {
        ...
        // Clique na tabela
        tabelaEstoque.addMouseListener(
                new MouseAdapter() {
    ...
    private RoundedPanel buildFormCard() {
        ...
        unidadeField.setToolTipText(
                "Exemplo: kg, g, L, ml, unidade"
        );

        card.add(unidadeField);
        ...
        quantidadeField.setToolTipText(
                "Digite um número. Exemplo: 10.5"
        );
        ...
        estoqueMinimoField.setToolTipText(
                "Quantidade mínima antes de precisar repor"
        );
        ...
        btnPanel.setAlignmentX(
                Component.LEFT_ALIGNMENT
        );

        RoundedButton limparBtn =
                new RoundedButton(
                        "LIMPAR"
                );
        ...
        deletarBtn.addActionListener(
                e -> deletarIngredienteComAdmin()
        );

        RoundedButton salvarBtn =
                new RoundedButton(
                        "SALVAR >"
                );
    ...
    private RoundedPanel buildSearchCard() {
        ...
        buscaField.setToolTipText(
                "Digite o nome ou categoria"
        );

        buscaField.addKeyListener(
                new KeyAdapter() {
    ...
    private void salvarIngrediente() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    this,
                    "Quantidade e estoque mínimo devem ser números válidos.",
                    "Erro",
    ...
    private void deletarIngredienteComAdmin() {
        ...
        if (idEstoqueSelecionado == null) {
            ...
            JOptionPane.showMessageDialog(
                    this,
                    "Selecione um ingrediente na tabela para excluir.",
                    "Atenção",
                    JOptionPane.WARNING_MESSAGE
            );
